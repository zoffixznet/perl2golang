...
211 self-contained Perl programs with recorded expectations. They are the
...
| `tier2/` | 72 | Script-shaped programs: subroutines, references, nested data, closures, regex, file and stdin I/O, command-line handling, error handling, core modules. |
